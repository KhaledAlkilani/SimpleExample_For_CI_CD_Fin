...
namespace SimpleExample.Tests.API
{
    public class UsersControllerTests
    {
        ...
        [Fact]
        public async Task Create_WhenInvalidData_ShouldReturnBadRequest()
        {
            // Arrange
            CreateUserDto createDto = new CreateUserDto
            {
        ...
        [Fact]
        public async Task Update_WhenInvalidData_ShouldReturnBadRequest()
        {
            // Arrange
            Guid userId = Guid.NewGuid();
            UpdateUserDto updateDto = new UpdateUserDto
            ...
            _mockService.Setup(x => x.UpdateAsync(userId, updateDto))
